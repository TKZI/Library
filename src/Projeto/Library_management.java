...
public class Library_management extends JFrame implements ActionListener {
	...
	public Library_management() {
		setTitle("Sistema de administração de Livros");
		setSize(600, 300);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == addButton) {
			...
			String[] columns = { "Livro ID", "Titulo do Livro", "Autor", "Editora", "Ano da Publicação  ", "ISBN", "Numero de Cópias"};
			...
			String bookID = JOptionPane.showInputDialog(this, "Entre com ID do livro à editar: ");
			for(int i = 0; i < books.size(); i++) {
			...
			String bookID = JOptionPane.showInputDialog(this, "Entre com ID do livro à deletar: ");
			for(int i = 0; i < books.size(); i++) {
				if (books.get(i)[0].equals(bookID)) {
					books.remove(i);
